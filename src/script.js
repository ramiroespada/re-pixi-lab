...
class MarchingSquares {
  constructor(canvasId, args = {}) {
    ...
    this.circleCount = args.circleCount || 2;
  ...
  generateCircle() {
    console.log("RE / [script.js:72]: this.width: ", this.width);
  ...
  generateMap() {
    ...
    console.log("RE / [script.js:100]: this.inputValues: ", this.inputValues);
    //the grid is one smaller in x and y direction than the input
    this.gridValues = new Array(this.inputValues.length - 1);
    console.log("RE / [script.js:103]: this.gridValues: ", this.gridValues);
